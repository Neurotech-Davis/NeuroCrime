...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\diego\\OneDrive\\Documents\\Coding\\Neurotech\\NeuroCrime\\NeuroCrime-Stim_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisNew_clip in new_clip:
        ...
        while continueRoutine:
            ...
            if clips.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if clips.status == STARTED:
                if bool(False) or clips.isFinished:
                    # keep track of stop time/frame for later
        ...
        for thisTrial_2 in trials_2:
            ...
            button_refresher.maxDuration = 7.5
            # keep track of which components have finished
        ...
        # completed repetitions repeats of 'trials_2'
